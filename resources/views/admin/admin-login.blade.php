...
@include('toast-notification')
    <div class="w-full max-w-md bg-gray-800 p-8 rounded-lg shadow-lg">
        ...
        <!-- Login Header -->
        <h2 class="text-2xl font-bold text-center text-blue-500">Admin SignIn</h2>
        <!-- <p class="text-center text-gray-400 text-sm mt-2">Enter your email and password to sign in!</p> -->

        <!-- Google Login Button -->
        <!-- <div class="mt-6">
    <a href="" class="flex items-center justify-center w-full py-2 px-4 bg-white text-gray-700 rounded-lg shadow-md hover:bg-gray-200">
           route('google-auth')
