...
<div class="bg-gray-100">
        ...
        <div class="flex flex-col mx-3 mt-6 lg:flex-row">
            <div class="w-full lg:w-1/3 m-1">
                <form action="{{route('admin.add_course')}}" method="POST" class="w-full bg-white shadow-md p-6" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="w-full md:w-full px-3 mb-6">
                            <button type="submit" class="appearance-none block w-full bg-green-700 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-green-600 focus:outline-none focus:bg-white focus:border-gray-500"
                            >Add Course</button>
                        </div>
            ...
            <div class="w-full lg:w-2/3 m-1 bg-white shadow-lg text-lg rounded-sm border border-gray-200 overflow-y-auto max-h-96">
