...
<style>
    ...
    input[type="checkbox"]:checked + label + .accordion-content {
        max-height: 1000px; /* Set this to accommodate your content's height */
...
<section id="topic-content" class="py-16 bg-gray-900">
    <div class="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-4 gap-6">
        <!-- Accordion Section (Left Side) -->
        <div class="bg-gray-800 rounded-lg shadow-lg col-span-1 lg:col-span-1 p-4">
    ...
    <div class="accordion-content bg-gray-600 text-sm max-h-0 overflow-hidden transition-all duration-300 peer-checked:max-h-screen p-4">
        ...
        <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden col-span-1 lg:col-span-3">
            <!-- Header -->
            <div class="bg-blue-500 p-4">
                <h3 class="text-2xl font-semibold text-white">{!! $content->content !!}</h3>
            </div>
