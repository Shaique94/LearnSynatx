    ...
    <section id="content" class="py-16 bg-white dark:bg-gray-800">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-bold text-center text-gray-800 dark:text-white mb-8">Module Content</h2>
            ...
            <div class="max-w-xl mx-auto py-10 px-5">
                ...
                <div class="bg-gray-800 rounded-lg shadow-lg">
                    ...
                    <div class="accordion-item border-b border-gray-700">
                        ...
                        <label for="item-{{ $key }}" class="block p-4 cursor-pointer text-lg font-semibold bg-white hover:bg-gray-600 transition dark:bg-gray-700">
                            {{ $chapter->title }}
                            <span class="float-right transform transition-transform duration-200 peer-checked:rotate-90">
                                &#9654; <!-- Right arrow -->
                            </span>
                        </label>
                        <div class="accordion-content bg-white text-sm max-h-0 overflow-hidden transition-all duration-300 peer-checked:max-h-screen p-4 dark:bg-gray-600">
                            ...
                            <ul>
                                ...
                                ]) }}" class="font-semibold text-gray-100 hover:text-blue-400 transition-colors dark:text-gray-200">
                                        {!! $content->content !!}
                                    </a>
                                </li>
                                @endforeach
